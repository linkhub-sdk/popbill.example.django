...
from popbill import BizInfoCheckService, PopbillException, JoinForm, ContactInfo, CorpInfo, RefundForm
...
def paymentRequest(request):
    ...
    try:
        CorpNum = settings.testCorpNum
        UserID = settings.testUserID
        response = bizInfoCheckService.paymentRequest(CorpNum, UserID)
...
def getSettleResult(request):
    ...
    try:
        CorpNum = settings.testCorpNum
        UserID = settings.testUserID
        response = bizInfoCheckService.getSettleResult(CorpNum, UserID)
