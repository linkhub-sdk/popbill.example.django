...
def getFlatRatePopUpURL(request):
    ...
    - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#GetFlatRatePopUpURL
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
...
def getBalance(request):
    """
    연동회원의 잔여포인트를 확인합니다.
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#GetBalance
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
...
def getChargeURL(request):
    ...
    - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#GetChargeURL
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
...
def getPaymentURL(request):
    ...
    - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#GetPaymentURL
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
...
def getUseHistoryURL(request):
    ...
    - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#GetUseHistoryURL
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
...
def getPartnerBalance(request):
    """
    파트너의 잔여포인트를 확인합니다.
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#GetPartnerBalance
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
...
def getPartnerURL(request):
    ...
    - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#GetPartnerURL
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
...
def paymentRequest(request):
    ...
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#PaymentRequest
    """
    try:
        # 팝빌회원 사업자번호 (하이픈 '-' 제외 10자리)
        CorpNum = settings.testCorpNum
...
def getSettleResult(request):
    ...
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#GetSettleResult
    """
    try:
        # 팝빌회원 사업자번호 (하이픈 '-' 제외 10자리)
        CorpNum = settings.testCorpNum
...
def getPaymentHistory(request):
    ...
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#GetPaymentHistory
    """
    try:
        # 팝빌회원 사업자번호 (하이픈 '-' 제외 10자리)
        CorpNum = settings.testCorpNum
...
def getUseHistory(request):
    ...
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#GetUseHistory
    """
    try:
        # 팝빌회원 사업자번호 (하이픈 '-' 제외 10자리)
        CorpNum = settings.testCorpNum
...
def refund(request):
    """
    연동회원 포인트를 환불 신청합니다.
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#Refund
    """
    try:
        # 팝빌회원 사업자번호 (하이픈 '-' 제외 10자리)
        CorpNum = settings.testCorpNum
...
def getRefundHistory(request):
    ...
    - - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#GetRefundHistory
    """
    try:
        # 팝빌회원 사업자번호 (하이픈 '-' 제외 10자리)
        CorpNum = settings.testCorpNum
...
def checkIsMember(request):
    ...
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/member#CheckIsMember
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
...
def checkID(request):
    ...
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/member#CheckID
    """
    try:
        # 중복확인할 아이디
        memberID = "testkorea"
...
def joinMember(request):
    """
    사용자를 연동회원으로 가입처리합니다.
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/member#JoinMember
    """
    try:
        # 회원정보
        newMember = JoinForm(
...
def getAccessURL(request):
    ...
    - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/member#GetAccessURL
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
...
def updateCorpInfo(request):
    """
    연동회원사의 회사정보를 수정 합니다.
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/member#UpdateCorpInfo
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
...
def getContactInfo(request):
    ...
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/member#GetContactInfo
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
...
def quitMember(request):
    ...
    - 관리자 계정만 사용 가능합니다.
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/member#QuitMember
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
...
def getRefundInfo(request):
    ...
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#GetRefundInfo
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
...
def getRefundableBalance(request):
    ...
    - https://developers.popbill.com/reference/easyfinbank/python/common-api/point#GetRefundableBalance
    """
    try:
        # 팝빌회원 사업자번호
        CorpNum = settings.testCorpNum
