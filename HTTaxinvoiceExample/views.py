...
from popbill import HTTaxinvoiceService, PopbillException, JoinForm, CorpInfo, ContactInfo, RefundForm
...
def paymentRequest(request):
    ...
    try:
        CorpNum = settings.testCorpNum
        UserID = settings.testUserID
        response = htTaxinvoiceService.paymentRequest(CorpNum, UserID)
...
def getSettleResult(request):
    ...
    try:
        CorpNum = settings.testCorpNum
        UserID = settings.testUserID
        response = htTaxinvoiceService.getSettleResult(CorpNum, UserID)
